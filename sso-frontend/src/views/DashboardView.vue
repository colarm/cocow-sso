<template>
  <div class="dashboard-page">
    <header class="topbar">
      ...
      <button class="btn btn-outline" :disabled="store.loading" @click="handleLogout">
        <span v-if="store.loading" class="spinner spinner-sm"></span>
        <span>{{ store.loading ? 'Signing out…' : 'Sign Out' }}</span>
      </button>
    </header>
